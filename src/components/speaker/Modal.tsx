    ...
    return (
        ...
        <Field>
          ...
          <Input name="name" value={name}
            onChange={(e) => setName(e.target.value)} placeholder="John Doe" minLength={4} required />
        </Field>
        <Field>
      <Label>Image Link</Label>
      <Input type="url" name="url" value={image}
            onChange={(e) => setImage(e.target.value)} required />
    </Field>
        <Field>
          <Label>Bio</Label>
          <Textarea name="bio" value={bio}
            onChange={(e) => setBio(e.target.value)} placeholder="A short bio about the speaker" minLength={10} required />
        </Field>
        <Field>
          <Label>Job</Label>
          <Textarea name="job" value={job}
            onChange={(e) => setJob(e.target.value)} placeholder="speaker role" minLength={3} required />
        </Field>
                </div>
