...
export default function Footer() {
  ...
  <g id="Layer_1-2" data-name="Layer 1">
    ...
    <path className={`${styles.f2} cls-1`} d="M394.14,35.69c-59.51-51.13-123.47-47.63-175.1,12.46l-61.56,71.65,25.19,85.85,91.81-106.87c29.64-34.51,55.87-36,79.74-15.45,23.57,20.25,26.09,46.4-3.55,80.9l-62.36,72.58,24.81,84.53,95.09-110.67c51.62-60.09,45.44-123.85-14.07-174.98Z"/>
        ...
        <div className="mx-auto pt-16 pb-8 sm:pt-24 lg:pt-26">
        <div className="ml-8 xl:grid xl:grid-cols-3 xl:gap-8">
        <Link href="/" className={`${styles.logo_footer}`}>
          ...
          <div className="mt-16 mb-10 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              ...
              <div className="mt-10 md:mt-0">
                <h3 className="text-sm/6 font-semibold text-white">Publication</h3>
                <ul role="list" className="mt-6 space-y-4">
        ...
        <div className="mt-8 border-t border-white/10 pt-8 md:flex md:items-center md:justify-between px-8">
