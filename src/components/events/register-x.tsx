...
//       <AnimatePresence>
//         {isOpen ? (
//           <Dialog eventId={eventId} close={() => setIsOpen(false)} />
//         ) : null}
//       </AnimatePresence>
//       <StyleSheet />
//     </>
...
//             <Heading className="titlee capitalize opacity-80">
//               Enter your details
//             </Heading>
...
//           </div>
//         )}
//         <button className="closeButtonnn" aria-label="Close" onClick={close}>
//           <CloseIcon />
//         </button>
//       </motion.dialog>
//     </>
