...
export default function NewEventModal({eventId}: {eventId: string}) {
    ...
    return (
        <>
            <motion.button
                ...
                whileTap={{ scale: 1.05 }}
                className="openButtonn rounded-md text-sm font-bold uppercase shadow-xs focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600"
        ...
        <>
            ...
            >
                {!transit ? (
                    ...
                    <Heading className="title capitalize opacity-80">Enter your details</Heading>
