...
export default function WaitlistHeaderMobile() {
    ...
    return (
        <>
            <motion.button
                ...
                whileTap={{ scale: 1.05 }}
                className={`${Nexa_Bold.className} openButtonn -mx-3 block rounded-lg px-3 py-2.5 text-base/7 font-semibold`}
    ...
    <g id="Outline">
      <g>
        ...
        <circle cx="7.99995" cy="32" r="1"/>
                    ...
                    <p className="text-center">🎉 Welcome to ChainTrade! You’re on the<br/> list — keep an eye on your inbox.</p>
                </div>)}
                <button
