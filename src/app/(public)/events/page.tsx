...
export default function Page() {
  ...
  return (
    <div className={`${styles.events}`}>
      <div
        className={`${styles.events_header} relative isolate overflow-hidden bg-gray-900 py-24 sm:py-32`}
      >
        <div
          aria-hidden="true"
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:mx-0">
            <h2 className="text-5xl font-semibold tracking-tight text-white sm:text-7xl lowercase opacity-80">
              Events
            </h2>
